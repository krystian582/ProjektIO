    ...
    <nav id="header" class="navbar navbar-expand bg-dark flex-column flex-md-row">
        <div class="navbar-nav-scroll">
            <ul class="nav nav-tabs bg-dark">
                ...
                <li class="nav-item">
                    <a class="nav-link ${param['pageName'] eq 'home' ?'active':''}"  href="receptaList.html" >Twoje Recepty</a>
                </li>
                </security:authorize>
                ...
                <security:authorize access="hasRole('USER')">
                    <li class="nav-item">
                        <a class="nav-link ${param['pageName'] eq 'wizyty' ?'active':''}"  href="wizytyList.html">Wizyty</a>
                    </li>
                </security:authorize>
